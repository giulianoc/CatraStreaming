...
*/
...
#ifndef MP4CprtAtom_h
	#define MP4CprtAtom_h
	...
	typedef class MP4CprtAtom: public MP4Atom {
		...
		private:
			...
			MP4StringLastProperty_t				_mstrlpNotice;

		protected:
			MP4CprtAtom (const MP4CprtAtom &);

			MP4CprtAtom &operator = (const MP4CprtAtom &);
		...
		public:
			...
			*/
			...
			Error getNotice (Buffer_p pbNotice);

			Error setNotice (Buffer_p pbNotice);

	} MP4CprtAtom_t, *MP4CprtAtom_p;
