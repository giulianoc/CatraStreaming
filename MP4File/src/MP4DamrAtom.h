...
#ifndef MP4DamrAtom_h
	#define MP4DamrAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4DamrAtom: public MP4Atom {

		private:
			MP4UInteger32BitsProperty_t			_mui32pVendor;
			MP4UInteger8BitsProperty_t			_mui8pDecoderVersion;
			MP4UInteger16BitsProperty_t			_mui16pModeSet;
			MP4UInteger8BitsProperty_t			_mui8pModeChangePeriod;
			MP4UInteger8BitsProperty_t			_mui8pFramesPerSample;

		protected:
			MP4DamrAtom (const MP4DamrAtom &);

			MP4DamrAtom &operator = (const MP4DamrAtom &);
