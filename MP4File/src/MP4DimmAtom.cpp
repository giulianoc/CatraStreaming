...
MP4DimmAtom:: MP4DimmAtom (void): MP4Atom ()
...
MP4DimmAtom:: MP4DimmAtom (const MP4DimmAtom &)
...
MP4DimmAtom &MP4DimmAtom:: operator = (const MP4DimmAtom &)
...
#ifdef WIN32
	Error MP4DimmAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4DimmAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4DimmAtom:: createProperties (
...
Error MP4DimmAtom:: readProperties (
	unsigned long *pulPropertiesSize)

{
	...
	// 0: bytes of immediate data
	if (_mui64pBytes. init ("Bytes", 1, _pfFile, _ptTracer) !=
		errNoError)
	{
		Error err = MP4FileErrors (__FILE__, __LINE__,
			MP4F_MP4UINTEGER64BITSPROPERTY_INIT_FAILED);
...
Error MP4DimmAtom:: writeProperties (int iFileDescriptor)
...
Error MP4DimmAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4DimmAtom:: getType (char *pType)
...
Error MP4DimmAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4DimmAtom:: printPropertiesOnStdOutput (void)
...
#ifdef WIN32
	Error MP4DimmAtom:: incrementBytes (__int64 llIncrement)
#else
	Error MP4DimmAtom:: incrementBytes (long long llIncrement)
#endif
{
