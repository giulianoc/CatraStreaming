...
#ifndef MP4DimmAtom_h
	#define MP4DimmAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4DimmAtom: public MP4Atom {

		private:
			MP4UInteger64BitsProperty_t				_mui64pBytes;

		protected:
			MP4DimmAtom (const MP4DimmAtom &);

			MP4DimmAtom &operator = (const MP4DimmAtom &);
