...
MP4DinfAtom:: MP4DinfAtom (void): MP4Atom ()
...
MP4DinfAtom:: MP4DinfAtom (const MP4DinfAtom &)
...
MP4DinfAtom &MP4DinfAtom:: operator = (const MP4DinfAtom &)
...
#ifdef WIN32
	Error MP4DinfAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4DinfAtom:: prepareChildrensAtomsInfo (void)

{
	...
	strcpy (ctiChildrenAtomInfo. _pType, "dref");
...
Error MP4DinfAtom:: createProperties (
...
Error MP4DinfAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4DinfAtom:: writeProperties (int iFileDescriptor)
...
Error MP4DinfAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4DinfAtom:: getType (char *pType)
...
Error MP4DinfAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4DinfAtom:: printPropertiesOnStdOutput (void)
