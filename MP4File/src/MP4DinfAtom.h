...
#ifndef MP4DinfAtom_h
	#define MP4DinfAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4DinfAtom: public MP4Atom {

		private:

		protected:
			MP4DinfAtom (const MP4DinfAtom &);

			MP4DinfAtom &operator = (const MP4DinfAtom &);
