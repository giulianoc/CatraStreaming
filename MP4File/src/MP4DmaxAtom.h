...
#ifndef MP4DmaxAtom_h
	#define MP4DmaxAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4DmaxAtom: public MP4Atom {

		private:
			MP4UInteger32BitsProperty_t				_mui32pMilliSecs;

		protected:
			MP4DmaxAtom (const MP4DmaxAtom &);

			MP4DmaxAtom &operator = (const MP4DmaxAtom &);
		...
		public:
			...
			Error getMilliSecs (unsigned long *pulMilliSecs);

			Error setMilliSecs (unsigned long ulMilliSecs);

	} MP4DmaxAtom_t, *MP4DmaxAtom_p;
