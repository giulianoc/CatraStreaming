...
MP4DmedAtom:: MP4DmedAtom (void): MP4Atom ()
...
MP4DmedAtom:: MP4DmedAtom (const MP4DmedAtom &)
...
MP4DmedAtom &MP4DmedAtom:: operator = (const MP4DmedAtom &)
...
#ifdef WIN32
	Error MP4DmedAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4DmedAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4DmedAtom:: createProperties (
...
Error MP4DmedAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4DmedAtom:: writeProperties (int iFileDescriptor)
...
Error MP4DmedAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4DmedAtom:: getType (char *pType)
...
Error MP4DmedAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4DmedAtom:: printPropertiesOnStdOutput (void)
...
#ifdef WIN32
	Error MP4DmedAtom:: incrementBytes (__int64 llIncrement)
#else
	Error MP4DmedAtom:: incrementBytes (long long llIncrement)
#endif
