...
#ifndef MP4DpndAtom_h
	#define MP4DpndAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4DpndAtom: public MP4Atom {
		...
		protected:
			MP4DpndAtom (const MP4DpndAtom &);

			MP4DpndAtom &operator = (const MP4DpndAtom &);
