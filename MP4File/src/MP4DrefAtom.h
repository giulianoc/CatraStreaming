...
#ifndef MP4DrefAtom_h
	#define MP4DrefAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4DrefAtom: public MP4Atom {

		private:
			MP4UInteger8BitsProperty_t				_mui8pVersion;
			MP4UInteger24BitsProperty_t				_mui24pFlags;
			MP4UInteger32BitsProperty_t				_mui32pEntryCount;

		protected:
			MP4DrefAtom (const MP4DrefAtom &);

			MP4DrefAtom &operator = (const MP4DrefAtom &);
		...
		public:
			...
			Error incrementEntryCount (long lIncrement);

	} MP4DrefAtom_t, *MP4DrefAtom_p;
