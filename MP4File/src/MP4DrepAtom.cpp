...
MP4DrepAtom:: MP4DrepAtom (void): MP4Atom ()
...
MP4DrepAtom:: MP4DrepAtom (const MP4DrepAtom &)
...
MP4DrepAtom &MP4DrepAtom:: operator = (const MP4DrepAtom &)
...
#ifdef WIN32
	Error MP4DrepAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4DrepAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4DrepAtom:: createProperties (
...
Error MP4DrepAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4DrepAtom:: writeProperties (int iFileDescriptor)
...
Error MP4DrepAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4DrepAtom:: getType (char *pType)
...
Error MP4DrepAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4DrepAtom:: printPropertiesOnStdOutput (void)
