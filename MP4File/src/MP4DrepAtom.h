...
#ifndef MP4DrepAtom_h
	#define MP4DrepAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4DrepAtom: public MP4Atom {

		private:
			MP4UInteger64BitsProperty_t				_mui64pBytes;

		protected:
			MP4DrepAtom (const MP4DrepAtom &);

			MP4DrepAtom &operator = (const MP4DrepAtom &);
