...
MP4EdtsAtom:: MP4EdtsAtom (void): MP4Atom ()
...
MP4EdtsAtom:: MP4EdtsAtom (const MP4EdtsAtom &)
...
MP4EdtsAtom &MP4EdtsAtom:: operator = (const MP4EdtsAtom &)
...
#ifdef WIN32
	Error MP4EdtsAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4EdtsAtom:: prepareChildrensAtomsInfo (void)

{
	...
	strcpy (ctiChildrenAtomInfo. _pType, "elst");
...
Error MP4EdtsAtom:: createProperties (
...
Error MP4EdtsAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4EdtsAtom:: writeProperties (int iFileDescriptor)
...
Error MP4EdtsAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4EdtsAtom:: getType (char *pType)
...
Error MP4EdtsAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4EdtsAtom:: printPropertiesOnStdOutput (void)
