...
#ifndef MP4EdtsAtom_h
	#define MP4EdtsAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4EdtsAtom: public MP4Atom {

		private:

		protected:
			MP4EdtsAtom (const MP4EdtsAtom &);

			MP4EdtsAtom &operator = (const MP4EdtsAtom &);
