...
MP4EsdsAtom:: MP4EsdsAtom (void): MP4Descr ()
...
MP4EsdsAtom:: MP4EsdsAtom (const MP4EsdsAtom &)
...
MP4EsdsAtom &MP4EsdsAtom:: operator = (const MP4EsdsAtom &)
...
#ifdef WIN32
	Error MP4EsdsAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...

{
	...
	return MP4Descr:: init (pmaParentAtom, pfFile,
		ullAtomStartOffset, ullAtomSize, ulHeaderSize, 0, 0,
		pmtMP4File, lAtomLevel, bUse64Bits, bUseMP4ConsistencyCheck,
		sStandard, ptTracer);
}


Error MP4EsdsAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4EsdsAtom:: createProperties (
...
Error MP4EsdsAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4EsdsAtom:: writeProperties (int iFileDescriptor)
...
Error MP4EsdsAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4EsdsAtom:: getType (char *pType)
...
Error MP4EsdsAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4EsdsAtom:: printPropertiesOnStdOutput (void)
