...
#ifndef MP4EsdsAtom_h
	#define MP4EsdsAtom_h

	#include "MP4Descr.h"
	#include "MP4FileErrors.h"


	typedef class MP4EsdsAtom: public MP4Descr {
		...
		protected:
			MP4EsdsAtom (const MP4EsdsAtom &);

			MP4EsdsAtom &operator = (const MP4EsdsAtom &);
