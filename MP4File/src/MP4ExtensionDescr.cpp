...
MP4ExtensionDescr:: MP4ExtensionDescr (void):
	MP4Descr ()
...
MP4ExtensionDescr:: MP4ExtensionDescr (
	const MP4ExtensionDescr &)
...
MP4ExtensionDescr &MP4ExtensionDescr:: operator = (
	const MP4ExtensionDescr &)
...
#ifdef WIN32
	Error MP4ExtensionDescr:: init (MP4Atom_p pmaParentAtom,
...
Error MP4ExtensionDescr:: prepareChildrensAtomsInfo (void)
...
Error MP4ExtensionDescr:: createProperties (
...
Error MP4ExtensionDescr:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4ExtensionDescr:: writeProperties (int iFileDescriptor)
...
Error MP4ExtensionDescr:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4ExtensionDescr:: printPropertiesOnStdOutput (void)
...
Error MP4ExtensionDescr:: getPropertiesSize (
	unsigned long *pulPropertiesSize)
...
Error MP4ExtensionDescr:: getType (char *pType)

{
	strcpy (pType, MP4_EXTENDEDDESCR_TYPE);
