...
*/
...
#ifndef MP4ExtensionDescr_h
	#define MP4ExtensionDescr_h
	...
	typedef class MP4ExtensionDescr: public MP4Descr {
	...
	} MP4ExtensionDescr_t, *MP4ExtensionDescr_p;
