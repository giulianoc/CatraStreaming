...
*/
...
#ifndef MP4Float32BitsProperty_h
	#define MP4Float32BitsProperty_h
	...
	typedef class MP4Float32BitsProperty: public MP4Property {

		private:
			float 					*_pfValues;

		public:
			MP4Float32BitsProperty (void);
	...
	} MP4Float32BitsProperty_t, *MP4Float32BitsProperty_p;
