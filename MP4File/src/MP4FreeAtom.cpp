...
MP4FreeAtom:: MP4FreeAtom (void): MP4Atom ()
...
MP4FreeAtom:: MP4FreeAtom (const MP4FreeAtom &)
...
MP4FreeAtom &MP4FreeAtom:: operator = (const MP4FreeAtom &)
...
#ifdef WIN32
	Error MP4FreeAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4FreeAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4FreeAtom:: createProperties (
...
Error MP4FreeAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4FreeAtom:: writeProperties (int iFileDescriptor)
...
Error MP4FreeAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4FreeAtom:: printPropertiesOnStdOutput (void)
...
Error MP4FreeAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4FreeAtom:: getType (char *pType)
