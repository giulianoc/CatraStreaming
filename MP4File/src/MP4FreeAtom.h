...
#ifndef MP4FreeAtom_h
	#define MP4FreeAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4FreeAtom: public MP4Atom {
		...
		protected:
			MP4FreeAtom (const MP4FreeAtom &);

			MP4FreeAtom &operator = (const MP4FreeAtom &);
