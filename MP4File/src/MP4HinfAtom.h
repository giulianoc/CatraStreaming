...
#ifndef MP4HinfAtom_h
	#define MP4HinfAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4HinfAtom: public MP4Atom {

		private:

		protected:
			MP4HinfAtom (const MP4HinfAtom &);

			MP4HinfAtom &operator = (const MP4HinfAtom &);
