...
#ifndef MP4HmhdAtom_h
	#define MP4HmhdAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"

	typedef class MP4HmhdAtom: public MP4Atom {

		private:
			MP4UInteger8BitsProperty_t				_mui8pVersion;
			MP4UInteger24BitsProperty_t				_mui24pFlags;
			MP4UInteger16BitsProperty_t				_mui16pMaxPduSize;
			MP4UInteger16BitsProperty_t				_mui16pAvgPduSize;
			MP4UInteger32BitsProperty_t				_mui32pMaxBitRate;
			MP4UInteger32BitsProperty_t				_mui32pAvgBitRate;
			MP4UInteger32BitsProperty_t				_mui32pSlidingAvgBitRate;

		protected:
			MP4HmhdAtom (const MP4HmhdAtom &);

			MP4HmhdAtom &operator = (const MP4HmhdAtom &);
		...
		public:
			...
			Error getMaxPduSize (unsigned long *pulMaxPduSize);

			Error setMaxPduSize (unsigned long ulMaxPduSize);

			Error getAvgPduSize (unsigned long *pulAvgPduSize);

			Error setAvgPduSize (unsigned long ulAvgPduSize);

			Error getMaxBitRate (unsigned long *pulMaxBitRate);

			Error setMaxBitRate (unsigned long ulMaxBitRate);

			Error getAvgBitRate (unsigned long *pulAvgBitRate);

			Error setAvgBitRate (unsigned long ulAvgBitRate);

	} MP4HmhdAtom_t, *MP4HmhdAtom_p;
