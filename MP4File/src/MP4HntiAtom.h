...
#ifndef MP4HntiAtom_h
	#define MP4HntiAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4HntiAtom: public MP4Atom {

		private:

		protected:
			MP4HntiAtom (const MP4HntiAtom &);

			MP4HntiAtom &operator = (const MP4HntiAtom &);
