...
#ifndef MP4IodsAtom_h
	#define MP4IodsAtom_h

	#include "MP4Descr.h"
	#include "MP4FileErrors.h"


	typedef class MP4IodsAtom: public MP4Descr {
		...
		protected:
			MP4IodsAtom (const MP4IodsAtom &);

			MP4IodsAtom &operator = (const MP4IodsAtom &);
