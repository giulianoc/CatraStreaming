...
#ifndef MP4IpirAtom_h
	#define MP4IpirAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4IpirAtom: public MP4Atom {
		...
		protected:
			MP4IpirAtom (const MP4IpirAtom &);

			MP4IpirAtom &operator = (const MP4IpirAtom &);
