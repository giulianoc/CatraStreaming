...
MP4MdiaAtom:: MP4MdiaAtom (void): MP4Atom ()
...
MP4MdiaAtom:: MP4MdiaAtom (const MP4MdiaAtom &)
...
MP4MdiaAtom &MP4MdiaAtom:: operator = (const MP4MdiaAtom &)
...
#ifdef WIN32
	Error MP4MdiaAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4MdiaAtom:: prepareChildrensAtomsInfo (void)

{
	...
	strcpy (ctiChildrenAtomInfo. _pType, "mdhd");
	...
	strcpy (ctiChildrenAtomInfo. _pType, "hdlr");
	ctiChildrenAtomInfo. _bMandatory		= true;
	ctiChildrenAtomInfo. _bOnlyOne			= true;
	...
	strcpy (ctiChildrenAtomInfo. _pType, "minf");
	ctiChildrenAtomInfo. _bMandatory		= true;
	ctiChildrenAtomInfo. _bOnlyOne			= true;
...
Error MP4MdiaAtom:: createProperties (
...
Error MP4MdiaAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4MdiaAtom:: writeProperties (int iFileDescriptor)
...
Error MP4MdiaAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4MdiaAtom:: getType (char *pType)
...
Error MP4MdiaAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4MdiaAtom:: printPropertiesOnStdOutput (void)
