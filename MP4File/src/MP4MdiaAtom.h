...
#ifndef MP4MdiaAtom_h
	#define MP4MdiaAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4MdiaAtom: public MP4Atom {

		private:

		protected:
			MP4MdiaAtom (const MP4MdiaAtom &);

			MP4MdiaAtom &operator = (const MP4MdiaAtom &);
