...
#ifndef MP4MfhdAtom_h
	#define MP4MfhdAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4MfhdAtom: public MP4Atom {

		private:
			MP4UInteger8BitsProperty_t				_mui8pVersion;
			MP4UInteger24BitsProperty_t				_mui24pFlags;
			MP4UInteger32BitsProperty_t				_mui32pSequenceNumber;

		protected:
			MP4MfhdAtom (const MP4MfhdAtom &);

			MP4MfhdAtom &operator = (const MP4MfhdAtom &);
