...
MP4MinfAtom:: MP4MinfAtom (void): MP4Atom ()
...
MP4MinfAtom:: MP4MinfAtom (const MP4MinfAtom &)
...
MP4MinfAtom &MP4MinfAtom:: operator = (const MP4MinfAtom &)
...
#ifdef WIN32
	Error MP4MinfAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4MinfAtom:: prepareChildrensAtomsInfo (void)

{
	...
	strcpy (ctiChildrenAtomInfo. _pType, "vmhd");
	...
	strcpy (ctiChildrenAtomInfo. _pType, "smhd");
	ctiChildrenAtomInfo. _bMandatory		= false;
	ctiChildrenAtomInfo. _bOnlyOne			= true;
	...
	strcpy (ctiChildrenAtomInfo. _pType, "hmhd");
	ctiChildrenAtomInfo. _bMandatory		= false;
	ctiChildrenAtomInfo. _bOnlyOne			= true;
	...
	strcpy (ctiChildrenAtomInfo. _pType, "nmhd");
	ctiChildrenAtomInfo. _bMandatory		= false;
	ctiChildrenAtomInfo. _bOnlyOne			= true;
	...
	strcpy (ctiChildrenAtomInfo. _pType, "dinf");
	...
	strcpy (ctiChildrenAtomInfo. _pType, "stbl");
	ctiChildrenAtomInfo. _bMandatory		= true;
	ctiChildrenAtomInfo. _bOnlyOne			= true;
...
Error MP4MinfAtom:: createProperties (
...
Error MP4MinfAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4MinfAtom:: writeProperties (int iFileDescriptor)
...
Error MP4MinfAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4MinfAtom:: getType (char *pType)
...
Error MP4MinfAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4MinfAtom:: printPropertiesOnStdOutput (void)
