...
#ifndef MP4MinfAtom_h
	#define MP4MinfAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4MinfAtom: public MP4Atom {

		private:

		protected:
			MP4MinfAtom (const MP4MinfAtom &);

			MP4MinfAtom &operator = (const MP4MinfAtom &);
