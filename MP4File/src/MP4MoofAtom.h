...
#ifndef MP4MoofAtom_h
	#define MP4MoofAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4MoofAtom: public MP4Atom {

		private:

		protected:
			MP4MoofAtom (const MP4MoofAtom &);

			MP4MoofAtom &operator = (const MP4MoofAtom &);
