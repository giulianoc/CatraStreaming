...
#ifndef MP4MoovAtom_h
	#define MP4MoovAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"

	typedef class MP4MoovAtom: public MP4Atom {

		private:

		protected:
			MP4MoovAtom (const MP4MoovAtom &);

			MP4MoovAtom &operator = (const MP4MoovAtom &);
