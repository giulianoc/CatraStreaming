...
MP4Mp4aAtom:: MP4Mp4aAtom (void): MP4Atom ()
...
MP4Mp4aAtom:: MP4Mp4aAtom (const MP4Mp4aAtom &)
...
MP4Mp4aAtom &MP4Mp4aAtom:: operator = (const MP4Mp4aAtom &)
...
#ifdef WIN32
	Error MP4Mp4aAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4Mp4aAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4Mp4aAtom:: createProperties (
...

{
	...
	*/
	...
	/*
	{
		...
		pucReserved2 [0][9]	= 0x02;
		pucReserved2 [0][11]	= 0x10;
...
Error MP4Mp4aAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4Mp4aAtom:: writeProperties (int iFileDescriptor)
...
Error MP4Mp4aAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4Mp4aAtom:: getType (char *pType)
...
Error MP4Mp4aAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4Mp4aAtom:: printPropertiesOnStdOutput (void)
