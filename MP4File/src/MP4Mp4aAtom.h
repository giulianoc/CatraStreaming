...
#ifndef MP4Mp4aAtom_h
	#define MP4Mp4aAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4Mp4aAtom: public MP4Atom {
		...
		protected:
			MP4Mp4aAtom (const MP4Mp4aAtom &);

			MP4Mp4aAtom &operator = (const MP4Mp4aAtom &);
