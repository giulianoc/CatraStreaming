...
#ifndef MP4Mp4sAtom_h
	#define MP4Mp4sAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4Mp4sAtom: public MP4Atom {
		...
		protected:
			MP4Mp4sAtom (const MP4Mp4sAtom &);

			MP4Mp4sAtom &operator = (const MP4Mp4sAtom &);
