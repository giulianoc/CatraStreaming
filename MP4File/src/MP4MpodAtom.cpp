...
MP4MpodAtom:: MP4MpodAtom (void): MP4Atom ()
...
MP4MpodAtom:: MP4MpodAtom (const MP4MpodAtom &)
...
MP4MpodAtom &MP4MpodAtom:: operator = (const MP4MpodAtom &)
...
#ifdef WIN32
	Error MP4MpodAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4MpodAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4MpodAtom:: createProperties (
...
Error MP4MpodAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4MpodAtom:: writeProperties (int iFileDescriptor)
...
Error MP4MpodAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4MpodAtom:: getType (char *pType)
...
Error MP4MpodAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4MpodAtom:: printPropertiesOnStdOutput (void)
