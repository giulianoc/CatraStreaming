...
#ifndef MP4MpodAtom_h
	#define MP4MpodAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4MpodAtom: public MP4Atom {
		...
		protected:
			MP4MpodAtom (const MP4MpodAtom &);

			MP4MpodAtom &operator = (const MP4MpodAtom &);
