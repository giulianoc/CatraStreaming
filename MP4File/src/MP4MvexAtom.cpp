...
MP4MvexAtom:: MP4MvexAtom (void): MP4Atom ()
...
MP4MvexAtom:: MP4MvexAtom (const MP4MvexAtom &)
...
MP4MvexAtom &MP4MvexAtom:: operator = (const MP4MvexAtom &)
...
#ifdef WIN32
	Error MP4MvexAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4MvexAtom:: prepareChildrensAtomsInfo (void)

{
	...
	strcpy (ctiChildrenAtomInfo. _pType, "trex");
...
Error MP4MvexAtom:: createProperties (
...
Error MP4MvexAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4MvexAtom:: writeProperties (int iFileDescriptor)
...
Error MP4MvexAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4MvexAtom:: getType (char *pType)
...
Error MP4MvexAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4MvexAtom:: printPropertiesOnStdOutput (void)
