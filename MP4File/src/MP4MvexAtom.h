...
#ifndef MP4MvexAtom_h
	#define MP4MvexAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4MvexAtom: public MP4Atom {

		private:

		protected:
			MP4MvexAtom (const MP4MvexAtom &);

			MP4MvexAtom &operator = (const MP4MvexAtom &);
