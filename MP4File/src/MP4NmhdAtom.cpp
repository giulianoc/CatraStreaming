...
MP4NmhdAtom:: MP4NmhdAtom (void): MP4Atom ()
...
MP4NmhdAtom:: MP4NmhdAtom (const MP4NmhdAtom &)
...
MP4NmhdAtom &MP4NmhdAtom:: operator = (const MP4NmhdAtom &)
...
#ifdef WIN32
	Error MP4NmhdAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4NmhdAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4NmhdAtom:: createProperties (
...
Error MP4NmhdAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4NmhdAtom:: writeProperties (int iFileDescriptor)
...
Error MP4NmhdAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4NmhdAtom:: getType (char *pType)
...
Error MP4NmhdAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4NmhdAtom:: printPropertiesOnStdOutput (void)
