...
#ifndef MP4NmhdAtom_h
	#define MP4NmhdAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4NmhdAtom: public MP4Atom {
		...
		protected:
			MP4NmhdAtom (const MP4NmhdAtom &);

			MP4NmhdAtom &operator = (const MP4NmhdAtom &);
