...
*/
...
#ifndef MP4PaytAtom_h
	#define MP4PaytAtom_h
	...
	typedef class MP4PaytAtom: public MP4Atom {

		private:
			MP4UInteger32BitsProperty_t				_mui32pPayloadNumber;
			MP4StringCountedProperty_t				_mstrcpRtpMap;

		protected:
			MP4PaytAtom (const MP4PaytAtom &);

			MP4PaytAtom &operator = (const MP4PaytAtom &);
		...
		public:
			...
			Error setRtpMap (Buffer_p pbRtpMap);

			Error getPayloadNumber (unsigned long *pulPayloadNumber);

			Error setPayloadNumber (unsigned long ulPayloadNumber);

	} MP4PaytAtom_t, *MP4PaytAtom_p;
