...
MP4PmaxAtom:: MP4PmaxAtom (void): MP4Atom ()
...
MP4PmaxAtom:: MP4PmaxAtom (const MP4PmaxAtom &)
...
MP4PmaxAtom &MP4PmaxAtom:: operator = (const MP4PmaxAtom &)
...
#ifdef WIN32
	Error MP4PmaxAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4PmaxAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4PmaxAtom:: createProperties (
...
Error MP4PmaxAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4PmaxAtom:: writeProperties (int iFileDescriptor)
...
Error MP4PmaxAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4PmaxAtom:: getType (char *pType)
...
Error MP4PmaxAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4PmaxAtom:: printPropertiesOnStdOutput (void)
...
Error MP4PmaxAtom:: getBytes (unsigned long *pulBytes)
...
Error MP4PmaxAtom:: setBytes (unsigned long ulBytes)
