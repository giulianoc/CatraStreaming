...
#ifndef MP4PmaxAtom_h
	#define MP4PmaxAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4PmaxAtom: public MP4Atom {

		private:
			MP4UInteger32BitsProperty_t				_mui32pBytes;

		protected:
			MP4PmaxAtom (const MP4PmaxAtom &);

			MP4PmaxAtom &operator = (const MP4PmaxAtom &);
