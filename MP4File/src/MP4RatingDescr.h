...
*/
...
#ifndef MP4RatingDescr_h
	#define MP4RatingDescr_h

	#include "MP4Descr.h"
	#include "MP4FileErrors.h"


	typedef class MP4RatingDescr: public MP4Descr {

		private:
			MP4UInteger32BitsProperty_t			_mui32pRatingEntity;
			MP4UInteger16BitsProperty_t			_mui16pRatingCriteria;
			MP4BytesProperty_t					_mbpRatingInfo;

		protected:
			MP4RatingDescr (
				const MP4RatingDescr &);

			MP4RatingDescr &operator = (
				const MP4RatingDescr &);
	...
	} MP4RatingDescr_t, *MP4RatingDescr_p;
