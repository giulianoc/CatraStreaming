...
#ifndef MP4RootAtom_h
	#define MP4RootAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4RootAtom: public MP4Atom {

		private:

		protected:
			MP4RootAtom (const MP4RootAtom &);

			MP4RootAtom &operator = (const MP4RootAtom &);
		...
		public:
			...
			Error moveMoovAtomAsLastAtom (void);

	} MP4RootAtom_t, *MP4RootAtom_p;
