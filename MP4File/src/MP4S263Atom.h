...
#ifndef MP4S263Atom_h
	#define MP4S263Atom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4S263Atom: public MP4Atom {
		...
		protected:
			MP4S263Atom (const MP4S263Atom &);

			MP4S263Atom &operator = (const MP4S263Atom &);
