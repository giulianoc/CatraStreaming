...
MP4SawbAtom:: MP4SawbAtom (void): MP4Atom ()
...
MP4SawbAtom:: MP4SawbAtom (const MP4SawbAtom &)
...
MP4SawbAtom &MP4SawbAtom:: operator = (const MP4SawbAtom &)
...
#ifdef WIN32
	Error MP4SawbAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4SawbAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4SawbAtom:: createProperties (
...
Error MP4SawbAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4SawbAtom:: writeProperties (int iFileDescriptor)
...
Error MP4SawbAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4SawbAtom:: getType (char *pType)
...
Error MP4SawbAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4SawbAtom:: printPropertiesOnStdOutput (void)
