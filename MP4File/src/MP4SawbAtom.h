...
#ifndef MP4SawbAtom_h
	#define MP4SawbAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4SawbAtom: public MP4Atom {
		...
		protected:
			MP4SawbAtom (const MP4SawbAtom &);

			MP4SawbAtom &operator = (const MP4SawbAtom &);
