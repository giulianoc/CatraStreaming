...
*/
	...
	typedef class MP4SdpAtom: public MP4Atom {

		private:
			MP4StringLastProperty_t					_mstrlpSdpText;

		protected:
			MP4SdpAtom (const MP4SdpAtom &);

			MP4SdpAtom &operator = (const MP4SdpAtom &);
		...
		public:
			...
			Error setSdpText (Buffer_p pbSdpText);

	} MP4SdpAtom_t, *MP4SdpAtom_p;
