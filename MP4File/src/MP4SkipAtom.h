...
#ifndef MP4SkipAtom_h
	#define MP4SkipAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4SkipAtom: public MP4Atom {
		...
		protected:
			MP4SkipAtom (const MP4SkipAtom &);

			MP4SkipAtom &operator = (const MP4SkipAtom &);
