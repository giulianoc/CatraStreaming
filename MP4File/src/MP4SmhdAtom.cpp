...
MP4SmhdAtom:: MP4SmhdAtom (void): MP4Atom ()
...
MP4SmhdAtom:: MP4SmhdAtom (const MP4SmhdAtom &)
...
MP4SmhdAtom &MP4SmhdAtom:: operator = (const MP4SmhdAtom &)
...
#ifdef WIN32
	Error MP4SmhdAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4SmhdAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4SmhdAtom:: createProperties (
...
Error MP4SmhdAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4SmhdAtom:: writeProperties (int iFileDescriptor)
...
Error MP4SmhdAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4SmhdAtom:: getType (char *pType)
...
Error MP4SmhdAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4SmhdAtom:: printPropertiesOnStdOutput (void)
