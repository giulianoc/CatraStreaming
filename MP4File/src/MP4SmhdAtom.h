...
#ifndef MP4SmhdAtom_h
	#define MP4SmhdAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4SmhdAtom: public MP4Atom {
		...
		protected:
			MP4SmhdAtom (const MP4SmhdAtom &);

			MP4SmhdAtom &operator = (const MP4SmhdAtom &);
