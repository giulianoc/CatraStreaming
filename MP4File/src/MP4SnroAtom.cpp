...
MP4SnroAtom:: MP4SnroAtom (void): MP4Atom ()
...
MP4SnroAtom:: MP4SnroAtom (const MP4SnroAtom &)
...
MP4SnroAtom &MP4SnroAtom:: operator = (const MP4SnroAtom &)
...
#ifdef WIN32
	Error MP4SnroAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4SnroAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4SnroAtom:: createProperties (
...
Error MP4SnroAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4SnroAtom:: writeProperties (int iFileDescriptor)

{
	...
	if (_mui32pOffset. write (iFileDescriptor) != errNoError)
	{
		Error err = MP4FileErrors (__FILE__, __LINE__,
...
Error MP4SnroAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)

{
	...
	*pulPropertiesSize					= 0;
	...
	if (_mui32pOffset. getSize (&ulSize) != errNoError)
	{
		Error err = MP4FileErrors (__FILE__, __LINE__,
...
Error MP4SnroAtom:: getType (char *pType)
...
Error MP4SnroAtom:: appendPropertiesDump (Buffer_p pbBuffer)

{
	...
	if (_mui32pOffset. appendDump (pbBuffer) != errNoError)
	{
		Error err = MP4FileErrors (__FILE__, __LINE__,
...
Error MP4SnroAtom:: printPropertiesOnStdOutput (void)

{
	...
	if (_mui32pOffset. printOnStdOutput () != errNoError)
	{
		Error err = MP4FileErrors (__FILE__, __LINE__,
...
Error MP4SnroAtom:: getOffset (unsigned long *pulOffset)

{
	...
	if (_mui32pOffset. getValue (pulOffset, 0) != errNoError)
	{
		Error err = MP4FileErrors (__FILE__, __LINE__,
...
Error MP4SnroAtom:: setOffset (unsigned long ulOffset)

{
	...
	if (_mui32pOffset. setValue (ulOffset, 0,
