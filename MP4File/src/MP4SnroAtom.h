...
#ifndef MP4SnroAtom_h
	#define MP4SnroAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4SnroAtom: public MP4Atom {

		private:
			MP4UInteger32BitsProperty_t					_mui32pOffset;

		protected:
			MP4SnroAtom (const MP4SnroAtom &);

			MP4SnroAtom &operator = (const MP4SnroAtom &);
