...
#ifndef MP4StblAtom_h
	#define MP4StblAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4StblAtom: public MP4Atom {

		private:

		protected:
			MP4StblAtom (const MP4StblAtom &);

			MP4StblAtom &operator = (const MP4StblAtom &);
