...
#ifndef MP4StdpAtom_h
	#define MP4StdpAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4StdpAtom: public MP4Atom {
		...
		private:
			...
			MP4UInteger16BitsProperty_t					_mui16pEntries;

		protected:
			MP4StdpAtom (const MP4StdpAtom &);

			MP4StdpAtom &operator = (const MP4StdpAtom &);
