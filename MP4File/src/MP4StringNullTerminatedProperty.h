...
*/
...
#ifndef MP4StringNullTerminatedProperty_h
	#define MP4StringNullTerminatedProperty_h
	...
	typedef class MP4StringNullTerminatedProperty: public MP4Property {
		...
		public:
			MP4StringNullTerminatedProperty (void);
			...
			Error init (const char *pName, unsigned long *pulBytesNumber,
	...
	} MP4StringNullTerminatedProperty_t, *MP4StringNullTerminatedProperty_p;
