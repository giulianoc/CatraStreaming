...
MP4StsdAtom:: MP4StsdAtom (void): MP4Atom ()
...
MP4StsdAtom:: MP4StsdAtom (const MP4StsdAtom &)
...
MP4StsdAtom &MP4StsdAtom:: operator = (const MP4StsdAtom &)
...
#ifdef WIN32
	Error MP4StsdAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4StsdAtom:: prepareChildrensAtomsInfo (void)

{
	...
	strcpy (ctiChildrenAtomInfo. _pType, "mp4a");
	...
	strcpy (ctiChildrenAtomInfo. _pType, "mp4s");
	ctiChildrenAtomInfo. _bMandatory		= false;
	ctiChildrenAtomInfo. _bOnlyOne			= false;
	...
	strcpy (ctiChildrenAtomInfo. _pType, "mp4v");
	ctiChildrenAtomInfo. _bMandatory		= false;
	ctiChildrenAtomInfo. _bOnlyOne			= false;
	...
	{
		strcpy (ctiChildrenAtomInfo. _pType, "samr");
		ctiChildrenAtomInfo. _bMandatory		= false;
		ctiChildrenAtomInfo. _bOnlyOne			= false;
		...
		strcpy (ctiChildrenAtomInfo. _pType, "sawb");
		ctiChildrenAtomInfo. _bMandatory		= false;
		ctiChildrenAtomInfo. _bOnlyOne			= false;
		...
		strcpy (ctiChildrenAtomInfo. _pType, "s263");
		ctiChildrenAtomInfo. _bMandatory		= false;
		ctiChildrenAtomInfo. _bOnlyOne			= false;
...
Error MP4StsdAtom:: createProperties (
...

{
	...
	// 2: EntryCount
	if (_mui32pEntryCount. init ("EntryCount",
...
Error MP4StsdAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4StsdAtom:: writeProperties (int iFileDescriptor)

{
	...
	if (_mui32pEntryCount. write (iFileDescriptor) != errNoError)
	{
		Error err = MP4FileErrors (__FILE__, __LINE__,
...
Error MP4StsdAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)

{
	...
	*pulPropertiesSize					+= ulSize;
	...
	if (_mui32pEntryCount. getSize (&ulSize) != errNoError)
	{
		Error err = MP4FileErrors (__FILE__, __LINE__,
...
Error MP4StsdAtom:: getType (char *pType)
...
Error MP4StsdAtom:: appendPropertiesDump (Buffer_p pbBuffer)

{
	...
	if (_mui32pEntryCount. appendDump (pbBuffer) != errNoError)
	{
		Error err = MP4FileErrors (__FILE__, __LINE__,
...
Error MP4StsdAtom:: printPropertiesOnStdOutput (void)

{
	...
	if (_mui32pEntryCount. printOnStdOutput () != errNoError)
	{
		Error err = MP4FileErrors (__FILE__, __LINE__,
...
Error MP4StsdAtom:: incrementEntryCount (long lIncrement)

{
	...
	if (_mui32pEntryCount. incrementValue (0, lIncrement) != errNoError)
	{
		Error err = MP4FileErrors (__FILE__, __LINE__,
