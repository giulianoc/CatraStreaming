...
#ifndef MP4StshAtom_h
	#define MP4StshAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4StshAtom: public MP4Atom {
		...
		protected:
			MP4StshAtom (const MP4StshAtom &);

			MP4StshAtom &operator = (const MP4StshAtom &);
