...
#ifndef MP4StssAtom_h
	#define MP4StssAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4StssAtom: public MP4Atom {
		...
		private:
			...
			MP4UInteger32BitsProperty_t					_mui32pSyncSampleTable;


		protected:
			MP4StssAtom (const MP4StssAtom &);

			MP4StssAtom &operator = (const MP4StssAtom &);
		...
		public:
			...
			Error getSyncSampleTable (unsigned long ulIndex,
				unsigned long *pulSyncSampleTable);

			Error setSyncSampleTable (unsigned long ulIndex,
				unsigned long ulSyncSampleTable);

	} MP4StssAtom_t, *MP4StssAtom_p;
