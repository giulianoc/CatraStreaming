...
*/
...
#ifndef MP4StszAtom_h
	#define MP4StszAtom_h
	...
	typedef class MP4StszAtom: public MP4Atom {

		private:
			MP4UInteger8BitsProperty_t					_mui8pVersion;
			MP4UInteger24BitsProperty_t					_mui24pFlags;
			MP4UInteger32BitsProperty_t					_mui32pCommonSampleSize;
			MP4UInteger32BitsProperty_t					_mui32pSamplesNumber;
			MP4UInteger32BitsProperty_t					_mui32pSampleSizeTable;

		protected:
			MP4StszAtom (const MP4StszAtom &);

			MP4StszAtom &operator = (const MP4StszAtom &);
		...
		public:
			...
			Error getSamplesNumber (unsigned long *pulSamplesNumber);

			Error setSamplesNumber (unsigned long ulSamplesNumber);

			Error incrementSamplesNumber (long llIncrement);

			Error getCommonSampleSize (unsigned long *pulCommonSampleSize);

			Error setCommonSampleSize (unsigned long ulCommonSampleSize);

			Error getSampleSizeTable (unsigned long ulIndex,
				unsigned long *pulSampleSizeTable);

			Error setSampleSizeTable (unsigned long ulIndex,
				unsigned long ulSampleSizeTable);

	} MP4StszAtom_t, *MP4StszAtom_p;
