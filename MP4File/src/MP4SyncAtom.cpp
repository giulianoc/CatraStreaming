...
MP4SyncAtom:: MP4SyncAtom (void): MP4Atom ()
...
MP4SyncAtom:: MP4SyncAtom (const MP4SyncAtom &)
...
MP4SyncAtom &MP4SyncAtom:: operator = (const MP4SyncAtom &)
...
#ifdef WIN32
	Error MP4SyncAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4SyncAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4SyncAtom:: createProperties (
...
Error MP4SyncAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4SyncAtom:: writeProperties (int iFileDescriptor)
...
Error MP4SyncAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4SyncAtom:: getType (char *pType)
...
Error MP4SyncAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4SyncAtom:: printPropertiesOnStdOutput (void)
