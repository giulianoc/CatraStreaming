...
*/
...
#ifndef MP4TfhdAtom_h
	#define MP4TfhdAtom_h
	...
	typedef class MP4TfhdAtom: public MP4Atom {
		...
		protected:
			MP4TfhdAtom (const MP4TfhdAtom &);

			MP4TfhdAtom &operator = (const MP4TfhdAtom &);
