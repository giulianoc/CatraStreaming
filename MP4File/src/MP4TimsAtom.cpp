...
MP4TimsAtom:: MP4TimsAtom (void): MP4Atom ()
...
MP4TimsAtom:: MP4TimsAtom (const MP4TimsAtom &)
...
MP4TimsAtom &MP4TimsAtom:: operator = (const MP4TimsAtom &)
...
#ifdef WIN32
	Error MP4TimsAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4TimsAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4TimsAtom:: createProperties (
...
Error MP4TimsAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4TimsAtom:: writeProperties (int iFileDescriptor)
...
Error MP4TimsAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4TimsAtom:: printPropertiesOnStdOutput (void)
...
Error MP4TimsAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4TimsAtom:: getType (char *pType)
...
Error MP4TimsAtom:: getTimeScale (unsigned long *pulTimeScale)
...
Error MP4TimsAtom:: setTimeScale (unsigned long ulTimeScale)
