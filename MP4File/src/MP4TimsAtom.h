...
*/
...
#ifndef MP4TimsAtom_h
	#define MP4TimsAtom_h
	...
	typedef class MP4TimsAtom: public MP4Atom {

		private:
			MP4UInteger32BitsProperty_t					_mui32pTimeScale;

		protected:
			MP4TimsAtom (const MP4TimsAtom &);

			MP4TimsAtom &operator = (const MP4TimsAtom &);
