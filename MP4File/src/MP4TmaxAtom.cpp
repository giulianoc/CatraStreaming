...
MP4TmaxAtom:: MP4TmaxAtom (void): MP4Atom ()
...
MP4TmaxAtom:: MP4TmaxAtom (const MP4TmaxAtom &)
...
MP4TmaxAtom &MP4TmaxAtom:: operator = (const MP4TmaxAtom &)
...
#ifdef WIN32
	Error MP4TmaxAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4TmaxAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4TmaxAtom:: createProperties (
...

{
	...
	// 0: max relative xmit time
	if (_mui32pMilliSecs. init ("MilliSecs",
...
Error MP4TmaxAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4TmaxAtom:: writeProperties (int iFileDescriptor)
...
Error MP4TmaxAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4TmaxAtom:: printPropertiesOnStdOutput (void)
...
Error MP4TmaxAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4TmaxAtom:: getType (char *pType)
