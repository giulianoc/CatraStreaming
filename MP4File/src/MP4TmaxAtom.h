...
*/
...
#ifndef MP4TmaxAtom_h
	#define MP4TmaxAtom_h
	...
	typedef class MP4TmaxAtom: public MP4Atom {

		private:
			MP4UInteger32BitsProperty_t					_mui32pMilliSecs;

		protected:
			MP4TmaxAtom (const MP4TmaxAtom &);

			MP4TmaxAtom &operator = (const MP4TmaxAtom &);
