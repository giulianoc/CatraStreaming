...
*/
...
#ifndef MP4TminAtom_h
	#define MP4TminAtom_h
	...
	typedef class MP4TminAtom: public MP4Atom {

		private:
			MP4UInteger32BitsProperty_t					_mui32pMilliSecs;

		protected:
			MP4TminAtom (const MP4TminAtom &);

			MP4TminAtom &operator = (const MP4TminAtom &);
