...
*/
...
#ifndef MP4TpylAtom_h
	#define MP4TpylAtom_h
	...
	typedef class MP4TpylAtom: public MP4Atom {

		private:
			MP4UInteger64BitsProperty_t					_mui64pBytes;

		protected:
			MP4TpylAtom (const MP4TpylAtom &);

			MP4TpylAtom &operator = (const MP4TpylAtom &);
