...
*/
...
#ifndef MP4TrafAtom_h
	#define MP4TrafAtom_h
	...
	typedef class MP4TrafAtom: public MP4Atom {

		private:

		protected:
			MP4TrafAtom (const MP4TrafAtom &);

			MP4TrafAtom &operator = (const MP4TrafAtom &);
