...
*/
...
#ifndef MP4TrakAtom_h
	#define MP4TrakAtom_h
	...
	typedef class MP4TrakAtom: public MP4Atom {

		private:

		protected:
			MP4TrakAtom (const MP4TrakAtom &);

			MP4TrakAtom &operator = (const MP4TrakAtom &);
