...
*/
...
#ifndef MP4TrefAtom_h
	#define MP4TrefAtom_h
	...
	typedef class MP4TrefAtom: public MP4Atom {

		private:

		protected:
			MP4TrefAtom (const MP4TrefAtom &);

			MP4TrefAtom &operator = (const MP4TrefAtom &);
