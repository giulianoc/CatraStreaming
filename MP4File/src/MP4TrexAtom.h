...
*/
...
#ifndef MP4TrexAtom_h
	#define MP4TrexAtom_h
	...
	typedef class MP4TrexAtom: public MP4Atom {
		...
		private:
			...
			MP4UInteger32BitsProperty_t		_mui32pDefaultSampleDesriptionIndex;
			MP4UInteger32BitsProperty_t			_mui32pDefaultSampleDuration;
			MP4UInteger32BitsProperty_t				_mui32pDefaultSampleSize;
			MP4UInteger32BitsProperty_t				_mui32pDefaultSampleFlags;

		protected:
			MP4TrexAtom (const MP4TrexAtom &);

			MP4TrexAtom &operator = (const MP4TrexAtom &);
