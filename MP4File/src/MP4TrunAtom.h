...
*/
...
#ifndef MP4TrunAtom_h
	#define MP4TrunAtom_h
	...
	typedef class MP4TrunAtom: public MP4Atom {

		private:
			MP4UInteger8BitsProperty_t					_mui8pVersion;
			MP4UInteger24BitsProperty_t					_mui24pFlags;
			MP4UInteger32BitsProperty_t					_mui32pSampleCount;

		protected:
			MP4TrunAtom (const MP4TrunAtom &);

			MP4TrunAtom &operator = (const MP4TrunAtom &);
