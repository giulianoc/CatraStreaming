...
MP4TsroAtom:: MP4TsroAtom (void): MP4Atom ()
...
MP4TsroAtom:: MP4TsroAtom (const MP4TsroAtom &)
...
MP4TsroAtom &MP4TsroAtom:: operator = (const MP4TsroAtom &)
...
#ifdef WIN32
	Error MP4TsroAtom:: init (MP4Atom_p pmaParentAtom,
		FileReader_p pfFile,
...
Error MP4TsroAtom:: prepareChildrensAtomsInfo (void)
...
Error MP4TsroAtom:: createProperties (
...
Error MP4TsroAtom:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4TsroAtom:: writeProperties (int iFileDescriptor)
...
Error MP4TsroAtom:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4TsroAtom:: printPropertiesOnStdOutput (void)
...
Error MP4TsroAtom:: getPropertiesSize (unsigned long *pulPropertiesSize)
...
Error MP4TsroAtom:: getType (char *pType)
...
Error MP4TsroAtom:: getOffset (unsigned long *pulOffset)
...
Error MP4TsroAtom:: setOffset (unsigned long ulOffset)
