...
*/
...
#ifndef MP4TsroAtom_h
	#define MP4TsroAtom_h
	...
	typedef class MP4TsroAtom: public MP4Atom {

		private:
			MP4UInteger32BitsProperty_t					_mui32pOffset;

		protected:
			MP4TsroAtom (const MP4TsroAtom &);

			MP4TsroAtom &operator = (const MP4TsroAtom &);
		...
		public:
			...
			Error getOffset (unsigned long *pulOffset);

			Error setOffset (unsigned long ulOffset);

	} MP4TsroAtom_t, *MP4TsroAtom_p;
