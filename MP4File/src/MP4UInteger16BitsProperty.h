...
*/
...
#ifndef MP4UInteger16BitsProperty_h
	#define MP4UInteger16BitsProperty_h
	...
	typedef class MP4UInteger16BitsProperty: public MP4Property {

		private:
			unsigned long 				*_pulValues;

		public:
			MP4UInteger16BitsProperty (void);
			...
			Error init (const char *pName, long lInstancesNumber,
				const unsigned char *pucValue, Tracer_p ptTracer);
	...
	} MP4UInteger16BitsProperty_t, *MP4UInteger16BitsProperty_p;
