...
*/
...
#ifndef MP4UInteger32BitsProperty_h
	#define MP4UInteger32BitsProperty_h
	...
	typedef class MP4UInteger32BitsProperty: public MP4Property {

		private:
			unsigned long 				*_pulValues;

		public:
			MP4UInteger32BitsProperty (void);
	...
	} MP4UInteger32BitsProperty_t, *MP4UInteger32BitsProperty_p;
