...
MP4UInteger8BitsProperty:: MP4UInteger8BitsProperty (void): MP4Property ()
...
MP4UInteger8BitsProperty:: ~MP4UInteger8BitsProperty (void)
...
Error MP4UInteger8BitsProperty:: init (const char *pName, long lInstancesNumber,
	Boolean_p pbIsImplicitProperty, unsigned long *pulValues, Tracer_p ptTracer)
...

{
	...
	for (lIntegerIndex = 0; lIntegerIndex < _lInstancesNumber; lIntegerIndex++)
	{
		if (pfFile -> readNetUnsignedInt8Bit (&(_pulValues [lIntegerIndex])) !=
			errNoError)
		{
...
Error MP4UInteger8BitsProperty:: getValue (unsigned long *pulValue, long lIndex)
...
Error MP4UInteger8BitsProperty:: getValue (unsigned char *pucValue, long lIndex)

{
	...
	pucValue [0]					= (unsigned char) (_pulValues [lIndex]);
...
Error MP4UInteger8BitsProperty:: setValue (unsigned long ulValue, long lIndex,
...
Error MP4UInteger8BitsProperty:: incrementValue (long lIndex, long lIncrement)
...
Error MP4UInteger8BitsProperty:: write (int iFileDescriptor)
...
Error MP4UInteger8BitsProperty:: getSize (unsigned long *pulSize)
...
Error MP4UInteger8BitsProperty:: getType (char *pType)

{

	strcpy (pType, "UInteger8Bits");
...
Error MP4UInteger8BitsProperty:: appendDump (Buffer_p pbBuffer)
...
Error MP4UInteger8BitsProperty:: printOnStdOutput (void)
