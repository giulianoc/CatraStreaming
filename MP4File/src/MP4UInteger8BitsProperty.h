...
*/
...
#ifndef MP4UInteger8BitsProperty_h
	#define MP4UInteger8BitsProperty_h
	...
	typedef class MP4UInteger8BitsProperty: public MP4Property {

		private:
			unsigned long 				*_pulValues;

		public:
			MP4UInteger8BitsProperty (void);
	...
	} MP4UInteger8BitsProperty_t, *MP4UInteger8BitsProperty_p;
