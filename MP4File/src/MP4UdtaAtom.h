...
*/
...
#ifndef MP4UdtaAtom_h
	#define MP4UdtaAtom_h
	...
	typedef class MP4UdtaAtom: public MP4Atom {

		private:

		protected:
			MP4UdtaAtom (const MP4UdtaAtom &);

			MP4UdtaAtom &operator = (const MP4UdtaAtom &);
