...
*/
...
#ifndef MP4UnknAtom_h
	#define MP4UnknAtom_h
	...
	typedef class MP4UnknAtom: public MP4Atom {

		private:
			MP4BytesProperty_t			_mbpData;

		protected:
			MP4UnknAtom (const MP4UnknAtom &);

			MP4UnknAtom &operator = (const MP4UnknAtom &);
