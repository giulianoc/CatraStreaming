...
MP4UnknownOCIDescr:: MP4UnknownOCIDescr (void):
	MP4Descr ()
...
MP4UnknownOCIDescr:: MP4UnknownOCIDescr (
	const MP4UnknownOCIDescr &)
...
MP4UnknownOCIDescr &MP4UnknownOCIDescr:: operator = (
	const MP4UnknownOCIDescr &)
...
#ifdef WIN32
	Error MP4UnknownOCIDescr:: init (MP4Atom_p pmaParentAtom,
...
Error MP4UnknownOCIDescr:: prepareChildrensAtomsInfo (void)
...
Error MP4UnknownOCIDescr:: createProperties (
...
Error MP4UnknownOCIDescr:: readProperties (
	unsigned long *pulPropertiesSize)
...
Error MP4UnknownOCIDescr:: writeProperties (int iFileDescriptor)
...
Error MP4UnknownOCIDescr:: appendPropertiesDump (Buffer_p pbBuffer)
...
Error MP4UnknownOCIDescr:: printPropertiesOnStdOutput (void)
...
Error MP4UnknownOCIDescr:: getPropertiesSize (
	unsigned long *pulPropertiesSize)
...
Error MP4UnknownOCIDescr:: getType (char *pType)

{
	strcpy (pType, MP4_UNKNOWNOCIDESCR_TYPE);
