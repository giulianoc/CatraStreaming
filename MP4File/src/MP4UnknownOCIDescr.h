...
*/
...
#ifndef MP4UnknownOCIDescr_h
	#define MP4UnknownOCIDescr_h
	...
	typedef class MP4UnknownOCIDescr: public MP4Descr {
	...
	} MP4UnknownOCIDescr_t, *MP4UnknownOCIDescr_p;
