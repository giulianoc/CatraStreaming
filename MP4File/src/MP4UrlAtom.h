...
*/
	...
	typedef class MP4UrlAtom: public MP4Atom {

		private:
			MP4UInteger8BitsProperty_t					_mui8pVersion;
			MP4UInteger24BitsProperty_t					_mui24pFlags;
			MP4StringLastProperty_t						_mstrlpLocation;

		protected:
			MP4UrlAtom (const MP4UrlAtom &);

			MP4UrlAtom &operator = (const MP4UrlAtom &);
		...
		public:
			...
			Error setFlags (unsigned long ulFlags);

			Error getFlags (unsigned long *pulFlags);

	} MP4UrlAtom_t, *MP4UrlAtom_p;
