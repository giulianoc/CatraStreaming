...
*/
	...
	typedef class MP4UrnAtom: public MP4Atom {

		private:
			MP4UInteger8BitsProperty_t					_mui8pVersion;
			MP4UInteger24BitsProperty_t					_mui24pFlags;
			MP4StringNullTerminatedProperty_t			_mstrpName;
			MP4StringNullTerminatedProperty_t			_mstrpLocation;

		protected:
			MP4UrnAtom (const MP4UrnAtom &);

			MP4UrnAtom &operator = (const MP4UrnAtom &);
