...
#ifndef MP4VmhdAtom_h
	#define MP4VmhdAtom_h

	#include "MP4Atom.h"
	#include "MP4FileErrors.h"


	typedef class MP4VmhdAtom: public MP4Atom {
		...
		protected:
			MP4VmhdAtom (const MP4VmhdAtom &);

			MP4VmhdAtom &operator = (const MP4VmhdAtom &);
