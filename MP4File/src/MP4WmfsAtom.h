...
*/
...
#ifndef MP4WmfsAtom_h
	#define MP4WmfsAtom_h
	...
	typedef class MP4WmfsAtom: public MP4Atom {

		private:
			MP4UInteger32BitsProperty_t				_mui32pMajorVersion;
			MP4UInteger32BitsProperty_t				_mui32pMinorVersion;
			MP4BytesProperty_t						_mbpReserved1;
			MP4UInteger32BitsProperty_t				_mui32pStorableFlag;

		protected:
			MP4WmfsAtom (const MP4WmfsAtom &);

			MP4WmfsAtom &operator = (const MP4WmfsAtom &);
