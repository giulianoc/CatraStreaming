...
*/
...
#ifndef CatraMonitoringPlayerMessages_h
	#define CatraMonitoringPlayerMessages_h
	...
	//
	enum CatraMonitoringPlayerMessagesCodes {
	...
	dclCustomMessageClass (CatraMonitoringPlayerMessages, MP4PL_MAXMESSAGES)
