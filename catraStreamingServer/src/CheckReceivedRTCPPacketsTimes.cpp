...
CheckReceivedRTCPPacketsTimes:: CheckReceivedRTCPPacketsTimes (void): Times ()
...
CheckReceivedRTCPPacketsTimes:: ~CheckReceivedRTCPPacketsTimes (void)
...
CheckReceivedRTCPPacketsTimes:: CheckReceivedRTCPPacketsTimes (const CheckReceivedRTCPPacketsTimes &t)
...
Error CheckReceivedRTCPPacketsTimes:: init (
...

{
	...
	if (Times:: init (ulPeriodInMilliSecs,
		SS_CHECKRECEIVEDRTCPPACKETSTIMES_CLASSNAME) != errNoError)
	{
...
Error CheckReceivedRTCPPacketsTimes:: finish (void)
...
Error CheckReceivedRTCPPacketsTimes:: handleTimeOut (void)

{
	...
	if (pevRTSPConnection -> init (
		SS_CHECKRECEIVEDRTCPPACKETSTIMES_SOURCE,
		SS_EVENT_RECEIVERTCPPACKETS, "SS_EVENT_RECEIVERTCPPACKETS",
