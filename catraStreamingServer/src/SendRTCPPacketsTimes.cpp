...
SendRTCPPacketsTimes:: SendRTCPPacketsTimes (void): Times ()
...
SendRTCPPacketsTimes:: ~SendRTCPPacketsTimes (void)
...
SendRTCPPacketsTimes:: SendRTCPPacketsTimes (const SendRTCPPacketsTimes &t)
...
Error SendRTCPPacketsTimes:: init (
...

{
	...
	if (Times:: init (ulPeriodInMilliSecs,
		SS_SENDRTCPPACKETSTIMES_CLASSNAME) != errNoError)
	{
...
Error SendRTCPPacketsTimes:: finish (void)
...
Error SendRTCPPacketsTimes:: handleTimeOut (void)

{
	...
	if (pevRTSPConnection -> init (
		SS_SENDRTCPPACKETSTIMES_SOURCE,
		SS_EVENT_SENDRTCPPACKETS, "SS_EVENT_SENDRTCPPACKETS",
