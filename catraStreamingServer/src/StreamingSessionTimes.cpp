...
StreamingSessionTimes:: StreamingSessionTimes (void): Times ()
...
StreamingSessionTimes:: ~StreamingSessionTimes (void)
...
StreamingSessionTimes:: StreamingSessionTimes (const StreamingSessionTimes &t)
...
Error StreamingSessionTimes:: init (
...

{
	...
	if (Times:: init (ulPeriod,
		SS_STREAMINGSESSIONTIMES_CLASSNAME) != errNoError)
	{
...
Error StreamingSessionTimes:: finish (void)
...
Error StreamingSessionTimes:: handleTimeOut (void)

{
	...
	if (pevRTSPConnection -> init (
		SS_STREAMINGSESSIONTIMES_SOURCE,
		SS_EVENT_STREAMINGSESSIONTIMEOUT, "SS_EVENT_STREAMINGSESSIONTIMEOUT",
